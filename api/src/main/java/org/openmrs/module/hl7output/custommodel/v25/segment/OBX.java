...
public class OBX extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(CE.class, true, 1, 483, new Object[]{ getMessage(), new Integer(0) }, "Observation Identifier");
                                  this.add(ST.class, false, -1, 20, new Object[]{ getMessage(), new Integer(0) }, "Observation Sub-ID");
                                  ...
                                  this.add(ST.class, false, -1, 60, new Object[]{ getMessage(), new Integer(0) }, "References Range");
                                  this.add(IS.class, false, -1, 5, new Object[]{ getMessage() }, "Abnormal Flags");
                                  this.add(NM.class, false, -1, 5, new Object[]{ getMessage(), new Integer(0) }, "Probability");
                                  this.add(ID.class, false, -1, 2, new Object[]{ getMessage() }, "Nature of Abnormal Test");
                                  this.add(ID.class, true, 1, 1, new Object[]{ getMessage() }, "Observation Result Status");
                                  this.add(TS.class, false, -1, 26, new Object[]{ getMessage(), new Integer(0) }, "Effective Date of Reference Range");
                                  this.add(ST.class, false, -1, 20, new Object[]{ getMessage(), new Integer(0) }, "User Defined Access Checks");
                                  this.add(TS.class, false, 1, 26, new Object[]{ getMessage(), new Integer(0) }, "Date/Time of the Observation");
                                  this.add(CE.class, false, -1, 483, new Object[]{ getMessage(), new Integer(0) }, "Producer's ID");
                                  this.add(XCN.class, false, -1, 2718, new Object[]{ getMessage(), new Integer(0) }, "Responsible Observer");
                                  this.add(CE.class, false, -1, 483, new Object[]{ getMessage(), new Integer(0) }, "Observation Method");
                                  this.add(EI.class, false, -1, 427, new Object[]{ getMessage(), new Integer(0) }, "Equipment Instance Identifier");
                                  this.add(TS.class, false, -1, 26, new Object[]{ getMessage(), new Integer(0) }, "Date/Time of the Analysis");

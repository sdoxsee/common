...
public class ORC extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(ID.class, true, 1, 2, new Object[]{ getMessage() }, "Order Control");
                                  ...
                                  this.add(EI.class, false, -1, 427, new Object[]{ getMessage(), new Integer(0) }, "Placer Group Number");
                                  this.add(ID.class, false, -1, 2, new Object[]{ getMessage() }, "Order Status");
                                  this.add(ID.class, false, -1, 1, new Object[]{ getMessage() }, "Response Flag");
                                  ...
                                  this.add(TS.class, false, -1, 26, new Object[]{ getMessage(), new Integer(0) }, "Date/Time of Transaction");
                                  this.add(XCN.class, false, -1, 2718, new Object[]{ getMessage(), new Integer(0) }, "Entered By");
                                  this.add(XCN.class, false, -1, 2718, new Object[]{ getMessage(), new Integer(0) }, "Verified By");
                                  this.add(XCN.class, false, -1, 2718, new Object[]{ getMessage(), new Integer(0) }, "Ordering Provider");
                                  this.add(PL.class, false, -1, 1230, new Object[]{ getMessage(), new Integer(0) }, "Enterer's Location");
                                  this.add(XTN.class, false, -1, 651, new Object[]{ getMessage(), new Integer(0) }, "Call Back Phone Number");
                                  this.add(TS.class, false, -1, 26, new Object[]{ getMessage(), new Integer(0) }, "Order Effective Date/Time");
                                  this.add(CE.class, false, -1, 483, new Object[]{ getMessage(), new Integer(0) }, "Order Control Code Reason");
                                  this.add(CE.class, false, -1, 483, new Object[]{ getMessage(), new Integer(0) }, "Entering Organization");
                                  this.add(CE.class, false, -1, 483, new Object[]{ getMessage(), new Integer(0) }, "Entering Device");
                                  this.add(XCN.class, false, -1, 2718, new Object[]{ getMessage(), new Integer(0) }, "Action By");
                                  this.add(CE.class, false, -1, 483, new Object[]{ getMessage(), new Integer(339) }, "Advanced Beneficiary Notice Code");
                                  this.add(XON.class, false, -1, 563, new Object[]{ getMessage(), new Integer(0) }, "Ordering Facility Name");
                                  this.add(XAD.class, false, -1, 578, new Object[]{ getMessage(), new Integer(0) }, "Ordering Facility Address");
                                  this.add(XTN.class, false, -1, 651, new Object[]{ getMessage(), new Integer(0) }, "Ordering Facility Phone Number");
                                  this.add(XAD.class, false, -1, 578, new Object[]{ getMessage(), new Integer(0) }, "Ordering Provider Address");
                                  this.add(CWE.class, false, -1, 705, new Object[]{ getMessage(), new Integer(0) }, "Order Status Modifier");
                                  this.add(CWE.class, false, -1, 705, new Object[]{ getMessage(), new Integer(552) }, "Advanced Beneficiary Notice Override Reason");
                                  this.add(TS.class, false, -1, 26, new Object[]{ getMessage(), new Integer(0) }, "Filler's Expected Availability Date/Time");
                                  this.add(CWE.class, false, -1, 705, new Object[]{ getMessage(), new Integer(177) }, "Confidentiality Code");
                                  this.add(CWE.class, false, -1, 705, new Object[]{ getMessage(), new Integer(482) }, "Order Type");
                                  this.add(CNE.class, false, -1, 705, new Object[]{ getMessage(), new Integer(483) }, "Enterer Authorization Mode");

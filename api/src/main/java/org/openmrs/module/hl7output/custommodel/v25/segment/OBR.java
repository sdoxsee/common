...
public class OBR extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(EI.class, false, -1, 427, new Object[]{ getMessage(), new Integer(0) }, "Placer Order Number");
                                  this.add(EI.class, false, -1, 427, new Object[]{ getMessage(), new Integer(0) }, "Filler Order Number");
                                  this.add(CE.class, true, 1, 483, new Object[]{ getMessage(), new Integer(0) }, "Universal Service Identifier");
                                  this.add(ID.class, false, -1, 2, new Object[]{ getMessage() }, "Priority _ OBR");
                                  ...
                                  this.add(CQ.class, false, -1, 500, new Object[]{ getMessage(), new Integer(0) }, "Collection Volume");
                                  this.add(XCN.class, false, -1, 2718, new Object[]{ getMessage(), new Integer(0) }, "Collector Identifier");
                                  this.add(ID.class, false, -1, 1, new Object[]{ getMessage() }, "Specimen Action Code");
                                  this.add(CE.class, false, -1, 483, new Object[]{ getMessage(), new Integer(0) }, "Danger Code");
                                  ...
                                  this.add(SPS.class, false, -1, 4436, new Object[]{ getMessage(), new Integer(0) }, "Specimen Source");
                                  this.add(XCN.class, false, -1, 2718, new Object[]{ getMessage(), new Integer(0) }, "Ordering Provider");
                                  this.add(XTN.class, false, -1, 651, new Object[]{ getMessage(), new Integer(0) }, "Order Callback Phone Number");
                                  ...
                                  this.add(MOC.class, false, -1, 504, new Object[]{ getMessage(), new Integer(0) }, "Charge to Practice");
                                  ...
                                  this.add(PRL.class, false, -1, 755, new Object[]{ getMessage(), new Integer(0) }, "Parent Result");
                                  this.add(TQ.class, false, -1, 1788, new Object[]{ getMessage(), new Integer(0) }, "Quantity/Timing");
                                  this.add(XCN.class, false, -1, 2718, new Object[]{ getMessage(), new Integer(0) }, "Result Copies To");
                                  this.add(EIP.class, false, -1, 855, new Object[]{ getMessage(), new Integer(0) }, "Parent");
                                  this.add(ID.class, false, -1, 20, new Object[]{ getMessage() }, "Transportation Mode");
                                  this.add(CE.class, false, -1, 483, new Object[]{ getMessage(), new Integer(0) }, "Reason for Study");
                                  this.add(NDL.class, false, -1, 838, new Object[]{ getMessage(), new Integer(0) }, "Principal Result Interpreter");
                                  this.add(NDL.class, false, -1, 838, new Object[]{ getMessage(), new Integer(0) }, "Assistant Result Interpreter");
                                  this.add(NDL.class, false, -1, 838, new Object[]{ getMessage(), new Integer(0) }, "Technician");
                                  this.add(NDL.class, false, -1, 838, new Object[]{ getMessage(), new Integer(0) }, "Transcriptionist");
                                  ...
                                  this.add(CE.class, false, -1, 483, new Object[]{ getMessage(), new Integer(0) }, "Transport Logistics of Collected Sample");
                                  this.add(CE.class, false, -1, 483, new Object[]{ getMessage(), new Integer(0) }, "Collector's Comment *");
                                  this.add(CE.class, false, -1, 483, new Object[]{ getMessage(), new Integer(0) }, "Transport Arrangement Responsibility");
                                  ...
                                  this.add(CE.class, false, -1, 483, new Object[]{ getMessage(), new Integer(0) }, "Planned Patient Transport Comment");
                                  this.add(CE.class, false, -1, 483, new Object[]{ getMessage(), new Integer(88) }, "Procedure Code");
                                  this.add(CE.class, false, -1, 483, new Object[]{ getMessage(), new Integer(340) }, "Procedure Code Modifier");
                                  this.add(CE.class, false, -1, 483, new Object[]{ getMessage(), new Integer(411) }, "Placer Supplemental Service Information");
                                  this.add(CE.class, false, -1, 483, new Object[]{ getMessage(), new Integer(411) }, "Filler Supplemental Service Information");
                                  this.add(CWE.class, false, -1, 705, new Object[]{ getMessage(), new Integer(476) }, "Medically Necessary Duplicate Procedure Reason.");
                                  this.add(IS.class, false, -1, 2, new Object[]{ getMessage() }, "Result Handling");

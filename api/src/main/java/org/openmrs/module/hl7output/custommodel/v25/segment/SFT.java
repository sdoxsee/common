...
public class SFT extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(XON.class, true, 1, 567, new Object[]{ getMessage(), new Integer(0) }, "Software Vendor Organization");
                                  this.add(ST.class, true, 1, 15, new Object[]{ getMessage(), new Integer(0) }, "Software Certified Version or Release Number");
                                  this.add(ST.class, true, 1, 20, new Object[]{ getMessage(), new Integer(0) }, "Software Product Name");
                                  this.add(ST.class, true, 1, 20, new Object[]{ getMessage(), new Integer(0) }, "Software Binary ID");
                                  this.add(TX.class, false, -1, 1024, new Object[]{ getMessage(), new Integer(0) }, "Software Product Information");

...
public class RXO extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(CE.class, false, -1, 483, new Object[]{ getMessage(), new Integer(0) }, "Requested Dosage Form");
                                  this.add(CE.class, false, -1, 483, new Object[]{ getMessage(), new Integer(0) }, "Provider's Pharmacy/Treatment Instructions");
                                  this.add(CE.class, false, -1, 483, new Object[]{ getMessage(), new Integer(0) }, "Provider's Administration Instructions");
                                  this.add(LA1.class, false, -1, 790, new Object[]{ getMessage(), new Integer(0) }, "Deliver-To Location");
                                  this.add(ID.class, false, -1, 1, new Object[]{ getMessage() }, "Allow Substitutions");
                                  this.add(CE.class, false, -1, 483, new Object[]{ getMessage(), new Integer(0) }, "Requested Dispense Code");
                                  ...
                                  this.add(XCN.class, false, -1, 2718, new Object[]{ getMessage(), new Integer(0) }, "Ordering Provider's DEA Number");
                                  this.add(XCN.class, false, -1, 2718, new Object[]{ getMessage(), new Integer(0) }, "Pharmacist/Treatment Supplier's Verifier ID");
                                  ...
                                  this.add(CE.class, false, -1, 483, new Object[]{ getMessage(), new Integer(0) }, "Requested Give Strength Units");
                                  ...
                                  this.add(CE.class, false, -1, 483, new Object[]{ getMessage(), new Integer(0) }, "Requested Give Rate Units");
                                  ...
                                  this.add(CWE.class, false, -1, 705, new Object[]{ getMessage(), new Integer(0) }, "Requested Drug Strength Volume Units");

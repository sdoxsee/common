...
public class TQ1 extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(CQ.class, false, -1, 500, new Object[]{ getMessage(), new Integer(0) }, "Quantity");
                                  this.add(RPT.class, false, -1, 984, new Object[]{ getMessage(), new Integer(335) }, "Repeat Pattern");
                                  this.add(TM.class, false, -1, 20, new Object[]{ getMessage(), new Integer(0) }, "Explicit Time");
                                  this.add(CQ.class, false, -1, 500, new Object[]{ getMessage(), new Integer(0) }, "Relative Time and Units");
                                  this.add(CQ.class, false, -1, 500, new Object[]{ getMessage(), new Integer(0) }, "Service Duration");
                                  ...
                                  this.add(CWE.class, false, -1, 705, new Object[]{ getMessage(), new Integer(485) }, "Priority");
                                  ...
                                  this.add(CQ.class, false, -1, 500, new Object[]{ getMessage(), new Integer(0) }, "Occurrence duration");

...
public class RXD extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(NM.class, true, 1, 4, new Object[]{ getMessage(), new Integer(0) }, "Dispense Sub-ID Counter");
                                  this.add(CE.class, true, 1, 483, new Object[]{ getMessage(), new Integer(292) }, "Dispense/Give Code");
                                  this.add(TS.class, true, 1, 26, new Object[]{ getMessage(), new Integer(0) }, "Date/Time Dispensed");
                                  ...
                                  this.add(CE.class, false, -1, 483, new Object[]{ getMessage(), new Integer(0) }, "Actual Dosage Form");
                                  ...
                                  this.add(ST.class, false, -1, 200, new Object[]{ getMessage(), new Integer(0) }, "Dispense Notes");
                                  this.add(XCN.class, false, -1, 2718, new Object[]{ getMessage(), new Integer(0) }, "Dispensing Provider");
                                  ...
                                  this.add(LA2.class, false, -1, 790, new Object[]{ getMessage(), new Integer(0) }, "Dispense-to Location");
                                  this.add(ID.class, false, -1, 1, new Object[]{ getMessage() }, "Needs Human Review");
                                  this.add(CE.class, false, -1, 483, new Object[]{ getMessage(), new Integer(0) }, "Pharmacy/Treatment Supplier's Special Dispensing Instructions");
                                  this.add(NM.class, false, -1, 20, new Object[]{ getMessage(), new Integer(0) }, "Actual Strength");
                                  this.add(CE.class, false, -1, 483, new Object[]{ getMessage(), new Integer(0) }, "Actual Strength Unit");
                                  this.add(ST.class, false, -1, 20, new Object[]{ getMessage(), new Integer(0) }, "Substance Lot Number");
                                  this.add(TS.class, false, -1, 26, new Object[]{ getMessage(), new Integer(0) }, "Substance Expiration Date");
                                  this.add(CE.class, false, -1, 483, new Object[]{ getMessage(), new Integer(227) }, "Substance Manufacturer Name");
                                  this.add(CE.class, false, -1, 483, new Object[]{ getMessage(), new Integer(0) }, "Indication");
                                  this.add(NM.class, false, -1, 20, new Object[]{ getMessage(), new Integer(0) }, "Dispense Package Size");
                                  this.add(CE.class, false, -1, 483, new Object[]{ getMessage(), new Integer(0) }, "Dispense Package Size Unit");
                                  this.add(ID.class, false, -1, 2, new Object[]{ getMessage() }, "Dispense Package Method");
                                  this.add(CE.class, false, -1, 483, new Object[]{ getMessage(), new Integer(0) }, "Supplementary Code");
                                  this.add(CE.class, false, -1, 483, new Object[]{ getMessage(), new Integer(0) }, "Initiating Location");
                                  this.add(CE.class, false, -1, 483, new Object[]{ getMessage(), new Integer(0) }, "Packaging/Assembly Location");
                                  this.add(NM.class, false, -1, 5, new Object[]{ getMessage(), new Integer(0) }, "Actual Drug Strength Volume");
                                  this.add(CWE.class, false, -1, 705, new Object[]{ getMessage(), new Integer(0) }, "Actual Drug Strength Volume Units");
                                  this.add(CWE.class, false, -1, 705, new Object[]{ getMessage(), new Integer(0) }, "Dispense to Pharmacy");
                                  this.add(XAD.class, false, -1, 578, new Object[]{ getMessage(), new Integer(0) }, "Dispense to Pharmacy Address");
                                  this.add(ID.class, false, -1, 1, new Object[]{ getMessage() }, "Pharmacy Order Type");
                                  this.add(CWE.class, false, -1, 705, new Object[]{ getMessage(), new Integer(484) }, "Dispense Type");
